...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img class="d-block w-100" src="admin/images/aduch.jpg" alt="First slide" style="width:100%; height: 600px;">

      <div class="carousel-caption d-none d-md-block" style="color:#f3ffe3; padding: 250px;">
            <h1 style="font-size: 80px;"><i>Kuliner Indonesia</i></h1>
            <h3>Beragam jenis rasa dengan ciri khasnya</h3>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid px-4">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <?php if(mysqli_num_rows($kuliner) > 0) {
              while ($row2 = mysqli_fetch_array($kuliner))
            { ?>
              <div class="media" style="border-bottom: 2px solid #97a2ff;">
                <div class="media-body">
                  <h4 class="mt-0 mb-1"><?php echo $row2["kulinerNAMA"] ?></h4><br>
                  <h6><?php echo $row2["kulinerNAMA"] ?>
                  <p><i><?php echo $row2["kulinerKODE"] ?> </i>|<i> <?php echo $row2["kulinerKODE"] ?></i></p>
                </div>
                <img class="ml-3" style="width: 200px; height: 120px; border-radius: 5px; margin-bottom:20px;" src="images/<?php echo $row2["kulinerGAMBAR"] ?>" alt="Gambar Tidak Ada">
              </div> <br>
            <?php } } ?>
          </div>
      </div>
...
<div class="row video-section-container">
  <div class="col-md-8 mx-auto" style="margin-bottom: 15px;">
    <div class="card border rounded">
      <div class="card-body" style="background-color:#97a2ff;">
        <div class="embed-responsive embed-responsive-16by9">
        <iframe width="560" height="315" src="https://www.youtube.com/embed/NhLC1qXKYfg?si=S1LBhmv721AN25pN" 
