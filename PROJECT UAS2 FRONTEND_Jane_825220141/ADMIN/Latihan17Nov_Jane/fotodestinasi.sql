...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 18, 2023 at 04:16 PM
...
CREATE TABLE `fotodestinasi` (
  ...
  `fotodestinasiFILE` char(225) NOT NULL
...
INSERT INTO `fotodestinasi` (`fotodestinasiKODE`, `fotodestinasiNAMA`, `fotodestinasiFILE`) VALUES
('JOO6', 'XHXHZJLLQ', 'candisari1.jpg'),
('nsaj', 'kdjak', 'bg-05.jpg');
