...
<?php
    ...
    $kodetransportasi = $_GET["ubah"];
    $edittransportasi = mysqli_query($connection,"select * from transportasi
        where transportasiKODE = '$kodetransportasi'");
            ...
            <form method="POST">
                <div class="mb-3 row"> 
                    ...
                    <div class="col-sm-10">
                        ...
                        value="<?php echo $rowedit["transportasiKODE"]?>" readonly>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="transportasiJENIS" class="col-sm-2 col-form-label"> Nama transportasi </label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="transportasiJENIS" id="transportasiJENIS"
                        value="<?php echo $rowedit["transportasiJENIS"]?>">
                    </div>
                </div>
