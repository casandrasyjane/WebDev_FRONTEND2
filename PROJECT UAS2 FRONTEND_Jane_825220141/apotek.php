...
<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
        <img class="d-block w-100" src="admin/images/nature.jpg" alt="First slide" style="width:100%; height: 600px;">

      <div class="carousel-caption d-none d-md-block" style="color:#f3ffe3; padding: 250px;">
            <h1 style="font-size: 80px;"><i>Apotek</i></h1>
            <h3>Macam-macam Obat</h3>
      </div>
    </div>
  </div>
  ...
  <div class="container-fluid px-4">
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <?php if(mysqli_num_rows($fotodestinasi) > 0) {
              while ($row2 = mysqli_fetch_array($fotodestinasi))
            { ?>
              <div class="media" style="border-bottom: 2px solid #97a2ff;">
                <div class="media-body">
                  <h4 class="mt-0 mb-1"><?php echo $row2["fotodestinasiNAMA"] ?></h4><br>
                  <h6><?php echo $row2["fotodestinasiKODE"] ?>
                  <p><i><?php echo $row2["destinasiKODE"] ?> </i>|<i> <?php echo $row2["fotodestinasiKODE"] ?></i></p>
                </div>
                <img class="ml-3" style="width: 200px; height: 120px; border-radius: 5px; margin-bottom:20px;" src="admin/images/<?php echo $row2["fotodestinasiFILE"] ?>" alt="Gambar Tidak Ada">
              </div> <br>
            <?php } } ?>
          </div>
      </div>
...
<div class="row">
  <div class="col-md-6 mx-auto">
    <div class="card mb-3" style="max-width: 900px">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="admin/images/fotodirijane.jpg" class="img-fluid rounded-start" alt="Profile Image" style="width: 200px; height: 350px;">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h1 class="card-title">Jane Syahwalina Kaprica Sandra</h1>
            <p class="card-text">825220141</p>
            <br>
            <p class="card-text">Mahasiswa Semester 3 Berkuliah Di Universitas Tarumanagara
                Jurusan Sistem Informasi angkatan 2022, Projek ini merupakan Tugas Akhir USA
                Mata Kuliah Web Development.
            </p>
            <br>
            <h4 class="card-text"><small class="text-muted">Contact: jane.825220141@stu.untar.ac.id</small></h4>
          </div>
        </div>
      </div>
    </div>
